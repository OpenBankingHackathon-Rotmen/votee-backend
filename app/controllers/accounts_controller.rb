class AccountsController < ApplicationController
	...
	def fetch_account 
		...
		redirect_to "https://votee.now.sh/redirect/?accountNumber=#{JSON.parse(a["account"]["accountNumber"])}&accountType=#{JSON.parse(a["account"]["accountType"]["accountHolderType"])}"
	end
end
